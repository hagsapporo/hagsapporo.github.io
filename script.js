...
const copy = {
  ja: {
    ...
    scheduleTitle: '<span class="heading-line">1日で、企画から</span><span class="heading-line">作品発表まで。</span>', scheduleNote: "各チーム3分で作品の面白さの核を発表します。発表数と審査状況により時刻を微調整する場合があります。",
    ...
    tt5: "Code Freeze・提出", tt5Body: "ビルド、操作方法、作品説明を提出", tt6: "作品発表・審査", tt6Body: "1チーム3分。最大20作品を想定した発表枠",
    tt7: "作品確認・審査", tt7Body: "審査員が必要に応じて作品を確認", tt8: "観客投票・審査集計", tt8Body: "審査員は協議、参加者は投票・軽食",
    ...
    tt13: "自由交流", tt13Body: "作品へのフィードバック、自由解散", tt14: "締め・参加者退出", tt14Body: "忘れ物を確認し、21:10までに退出",
    tt15: "運営撤収", tt15Body: "原状復帰し、21:30完全撤収",
    ...
    return3: "公式サイト・SNS・開催レポート掲載", return4: "企業賞・AI/技術支援の共同設計", partnerStatus: "北海道大学内の関係組織と後援を調整中",
    partnerStatusBody: "会場：北海道大学 エンレイソウ", partnersButton: "協賛・連携について相談する",
    organizerImageAlt: "イベント会場で参加者と交流するHAG発起人の町原悠太", organizerEyebrow: "発起人・プロジェクトリーダー", organizerName: "町原 悠太", organizerRole: "北海道大学工学部 情報学科3年（休学中）",
    ...
    footerOrganizer: "主催：北海道大学ゲーム制作サークルGamma",
  },
  en: {
    ...
    tt5: "Code Freeze and submission", tt5Body: "Submit the build, controls, and game description", tt6: "Game pitches and judging", tt6Body: "Three minutes per team, with room for up to 20 entries",
    tt7: "Game review and judging", tt7Body: "Judges inspect entries as needed", tt8: "Voting and deliberation", tt8Body: "Judges deliberate while participants vote and eat",
    ...
    tt13: "Open conversation", tt13Body: "Feedback, connections, and optional departure", tt14: "Closing and participant exit", tt14Body: "Final notices and departure by 21:10",
    tt15: "Organizer teardown", tt15Body: "Restore the venue and finish by 21:30",
    ...
    organizerImageAlt: "HAG founder Yuta Machihara meeting people at a community event", organizerEyebrow: "FOUNDER AND PROJECT LEAD", organizerName: "Yuta Machihara", organizerRole: "Third-year Information Engineering student at Hokkaido University, currently on leave",
    ...
    footerOrganizer: "Organized by Hokkaido University Game Development Circle Gamma",
  },
};
